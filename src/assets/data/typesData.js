...
export const resultsSets = {
  eyebrows: [
    {
      title: "眉毛",
      options: [
        { title: "上揚", value: "browsRise" },
        { title: "下垂", value: "browsDroop" },
        { title: "太近", value: "browsClose" },
        { title: "太遠", value: "browsWide" },
        { title: "高", value: "browsHigh" },
        { title: "低", value: "browsLow" },
        { title: "長過眼", value: "browsLong" },
        { title: "短", value: "browsShort" },
        { title: "眉壓眼", value: "browsPressEyes" },
        // { title: "眉毛無法辨識", value: "browsUncertain" },
        { title: "眉毛註解", value: "browsAnnotation" },
      ],
    },
  ],
  eyes: [
    {
      title: "眼睛",
      options: [
        { title: "大", value: "eyesBig" },
        { title: "小", value: "eyesSmall" },
        { title: "圓", value: "eyesRound" },
        { title: "長", value: "eyesLong" },
        { title: "眼頭垂", value: "eyesDroopInner" },
        { title: "眼頭圓", value: "eyesRoundInner" },
        // { title: "眼睛無法辨識", value: "eyesUncertain" },
        { title: "眼睛註解", value: "eyesAnnotation" },
      ],
    },
  ],
  // nose: [
  ...
  //       { title: "鼻子無法辨識", value: "noseUncertain" },
  //       { title: "鼻子註解", value: "noseAnnotation" },
  //     ],
  //   },
  // ],
  // mouth: [
  ...
  //       { title: "薄唇", value: "mouthThin" },
  //       { title: "嘴巴無法辨識", value: "mouthUncertain" },
  //       { title: "嘴巴註解", value: "mouthAnnotation" },
  //     ],
  //   },
  // ],
  // chin: [
